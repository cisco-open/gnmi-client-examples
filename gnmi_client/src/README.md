...
- [Explanation of Content](#explanation-of-content)
- [Server Setup](#server-setup)
- [How to Run The Function and Explanation](#how-to-run-the-function-and-explanation)
- [Customizing get_interface_stats](#customizing-get_interface_stats)
...
> [!NOTE]  
> If you only want to be able to run the code then you only need to follow the Server Setup and How to Run the Function and Explanation sections.
...
#### How to Run the Function and Explanation
...
Other arguments which are hardcoded into the function but can be changed by the user. More information found here: [Customizing get_interface_stats](#customizing-get_interface_stats)
...
#### Customizing get_interface_stats
